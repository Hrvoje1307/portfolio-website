      ...
      >
        ...
        <Box css={{ width: { base: "100%", lg: "49%" } }}>
          ...
          >
            ...
            <span className={css({ color: "#00D3F3" })}>Next.js</span>, I focus
            on creating seamless user experiences. I believe that great code is
            not just about functionality&dash;it&apos;s about maintainability,
